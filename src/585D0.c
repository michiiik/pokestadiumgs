...
#ifdef VERSION_US
extern s32 func_8005B378(s32, s32, s32);
extern s32 func_8005B4B8(s32, s32, s32);
extern s32 func_8005B5D4(s32, s32, s32);
s32 func_8005B6F0(s32 arg0, s32 arg1, s32 arg2) {
    switch (func_8005D92C(arg1)) {
        case 1: case 2: case 3: case 4:
            return func_8005B378(arg0, arg1, arg2);
        case 5: case 6:
            return func_8005B4B8(arg0, arg1, arg2);
        case 7:
            return func_8005B5D4(arg0, arg1, arg2);
    }
}
#endif
...
#ifdef VERSION_US
extern u8 func_8005D92C(s32 index);
extern void func_8005C0B0(s32, s32, s32);
extern void func_8005C12C(s32, s32, s32);
extern void func_8005C1AC(s32, s32, s32);
void func_8005C22C(s32 arg0, s32 arg1, s32 arg2) {
    switch (func_8005D92C(arg1)) {
    case 1:
    case 2:
    case 3:
    case 4:
        func_8005C0B0(arg0, arg1, arg2);
        break;
    case 5:
    case 6:
        func_8005C12C(arg0, arg1, arg2);
        break;
    case 7:
        func_8005C1AC(arg0, arg1, arg2);
        break;
    }
}
#endif
...
#ifdef VERSION_US
extern void func_8005C2B4(s32, s32, s32);
extern void func_8005C2FC(s32, s32, s32);
extern void func_8005C348(s32, s32, s32);
void func_8005C394(s32 arg0, s32 arg1, s32 arg2) {
    switch (func_8005D92C(arg1)) {
        case 1:
        case 2:
        case 3:
        case 4:
            func_8005C2B4(arg0, arg1, arg2);
            break;
        case 5:
        case 6:
            func_8005C2FC(arg0, arg1, arg2);
            break;
        case 7:
            func_8005C348(arg0, arg1, arg2);
            break;
    }
}
#endif
...
void func_8005C614(s32 arg0, s32 arg1) {
    switch (func_8005D92C(arg1)) {
        ...
        case 3:
        case 4:
            func_8005C52C(arg0, arg1);
            break;
        case 5:
        case 6:
            func_8005C584(arg0, arg1);
            break;
        case 7:
            func_8005C5CC(arg0, arg1);
            break;
    }
    func_8005C41C(arg0);
}
...
void func_8005C750(s32 arg0, s32 arg1) {
    u8 temp_v0;
    func_8005C41C(arg0, arg1);
    temp_v0 = func_8005D92C(arg1);
    switch (temp_v0) {
    case 1:
    case 2:
    case 3:
    case 4:
        func_8005C694(arg0, arg1);
        return;
    case 5:
    case 6:
        func_8005C6D8(arg0, arg1);
        return;
    case 7:
        func_8005C714(arg0, arg1);
        return;
    }
}
#endif
...
#ifdef VERSION_US
extern u8 D_801285D0[];
extern s32 func_8005BFA8(s32, s32);
extern s32 func_8005CAA4(s32);
s32 func_8005CC14(s32 arg0, s32 arg1, s32 arg2) {
    s32 result = 0;
    ...
    switch (arg0) {
    case 0x20:
        result = *(u8 *)(record + 0x9AC);
        break;
    case 0x21:
        result = func_8005BFA8(arg1, arg2);
        break;
    case 0x22:
        result = *(u8 *)(record + 0x266);
        break;
    case 0x23:
        result = 1;
        break;
    case 0x2B:
        result = *(u8 *)(record + 0x49);
        break;
    }
...
#ifdef CC_CHECK
#define RETURN_NO_VALUE return 0
#else
#define RETURN_NO_VALUE return
#endif
s32 func_8005DD14(s32 arg0, void *arg1) {
    if ((*(s32 *)(D_80128570 + arg0 * 112) & 1) == 0) {
        return 0;
    }
    switch (func_8005D92C(arg0)) {
        case 1: case 2: case 3: case 4:
            func_80060EC8(*(u8 **)(D_80128570 + arg0 * 112 + 0x60) + 0x18, arg1);
            RETURN_NO_VALUE;
        case 5: case 6:
            func_80060EC8(*(u8 **)(D_80128570 + arg0 * 112 + 0x60) + 0xB, arg1);
            RETURN_NO_VALUE;
        case 7:
            func_80060EC8(*(u8 **)(D_80128570 + arg0 * 112 + 0x60) + 0xB, arg1);
            RETURN_NO_VALUE;
...
s32 func_80060368(s32 arg0) {
    ...
    switch (func_8005D92C(arg0)) {
        case 1: case 2: case 3: case 4:
            value = func_80060A4C(*(u8 **)(D_80128570 + arg0 * 112 + 0x60) + 0x2D0);
            result = ((value & 0xF000) >> 12) % 10 * 1000 + ((value & 0xF00) >> 8) % 10 * 100 + ((value & 0xF0) >> 4) % 10 * 10 + (value & 0xF) % 10;
            break;
        case 5: case 6:
            result = func_80060A4C(*(u8 **)(D_80128570 + arg0 * 112 + 0x60) + 0x3E2);
            break;
        case 7:
            result = func_80060A4C(*(u8 **)(D_80128570 + arg0 * 112 + 0x60) + 0x3E3);
            break;
    }
    return result;
}
